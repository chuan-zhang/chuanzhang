...
<head>
    ...
    <link rel="stylesheet" href="css/hightlight.css">
		...
		.modal {
		  ...
		  background-color: rgba(0,0,0,0.4); /* 添加半透明效果 */
		}
    ...
    <div class="layout-wrap">
        <header class="layout-header">
            <div class="container" data-flex="main:justify cross:start">
                ...
                <div class="header-logo">
                    <h2 class="logo"><a class="links" href="https://bbs.119.cab/"><span class="logo-title">获取源码</span></a></h2>
                </div>
            </div>
        </header>
                    ...
                    <div class="article-box">
                        <div class="precast-block" data-flex="main:left">
                            ...
                            <div class="input-group">
                                <button onclick="openModal()">对话记录</button>
